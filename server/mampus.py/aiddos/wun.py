...
import sumplak as kyros
hostskaka = 'https://dns.google.com/methods/auth.login?format=json&email=' + '&password='
hosts = s.split
...
X>X<X>X<X>X<X>X 1-LEG!! X<X>X<X>X<X>X>X<X>X<X>X<X>X 1-LEG!! X<X>X<X>X<X>@@@@@@@@@@@@@@@@
         ...
         --THANKS TO MANTAP-VPN, THANKS TO Jim Dennis, AND THANKS TO NOLEPARMY THO--
...
def login():
    try:
        ...
        print('')
        print(47 * '\x1b[1;93m\xe2\x96\xac')
        print('\x1b[1;93m[1] \x1b[1;92mIstirahatkan Serangan\n')
        print('\x1b[1;93m[2] \x1b[1;92mPilihan lain\n')
        print('\x1b[1;93m[3] \x1b[1;92mPilih 92mPilihan lain lalu Serangan ini\n')
