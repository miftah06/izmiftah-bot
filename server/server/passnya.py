...
def randint(discover='', oa=''):
    ...
    if int(packet) > 1024:
        ...
        send_packet = pinject.md5(str(discover.randint(1,
...
class Index(object):
    ...
    def __send(
        ...
        ip = struct.IP(self.target, soldier, udp,
