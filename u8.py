...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("aiddos was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update aiddos.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From aiddos.git")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("aiddos is up-to-date")
        mesgdcrt.GeneralMessage("Starting aiddos")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("aiddos was created by SpeedX")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("aiddos will work only in Python v3")
    sys.exit()
...
description = """aiddos - Your Friendly Spammer Application

aiddos can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

aiddos is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by SpeedX !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start aiddos with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start aiddos with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start aiddos with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update aiddos")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current aiddos contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current aiddos version")
